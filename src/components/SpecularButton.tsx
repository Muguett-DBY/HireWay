...
// A shine effect sweeps this button's edge; the rest is a plain <button>.
export function SpecularButton({
  ...
  // Refs must not be written during render; keep the values the render loop
  // reads in sync via an effect instead.
  useEffect(() => {
    propsRef.current = {
      radius,
      lineColor,
